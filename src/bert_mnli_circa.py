...
parser.add_argument('-s', '--saveDir', default='/home/trawat2/LearningProject/Iwouldrather/test-bert-mnli-circa')
args = parser.parse_args()



pretrained_model = '/home/trawat2/LearningProject/Iwouldrather/test-mnli/MNLI/' #str(args.model)

modelPath = '/home/trawat2/LearningProject/Iwouldrather/test-mnli/MNLI'
...
tokenizer = torch.load(modelPath+'/tokenizer', map_location=device) #AutoTokenizer.from_pretrained(pretrained_model, truncation=True, do_lower_case=True)
...
class BERT(torch.nn.Module):
    def __init__(self):
        ...
        model=torch.load(modelPath+'/model', map_location=device)
        #print(model)
        self.l1=model.l1
...
if __name__ == '__main__':
    ...
    '''
    print("BERT_MNLI_Circa Question only")
    ...
    torch.save(tokenizer, savePath+'/QuestionOnly/tokenizer')
    
    
    print("BERT_MNLI_Circa Answer Only")
    ...
    torch.save(tokenizer, savePath+'/AnswerOnly//tokenizer')
    '''

    

    print("BERT_MNLI_Circa Question and Answer Pair")
    ...
    torch.save(tokenizer, savePath+'/QuestionAnswer/tokenizer')
